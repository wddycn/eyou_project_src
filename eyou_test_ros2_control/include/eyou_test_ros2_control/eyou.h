...
public:
    ...
    * ========================================================= */
    static float getMotorRatedTorque(uint8_t motor_id) {
        switch (motor_id) {
            case 8:  case 9:  return 6.6f;
            case 10: case 11: return 4.4f;
            case 12: case 13: return 1.0f; // 注意这里是 1.0
            default:
    ...
    * ========================================================= */
        ...
        double decel_rad_s2)        // 目标减速度 (rad/s²)
    {
        ...
        if (!receiveFrame(rx)) return false;
    ...
    * ========================================================= */
    ...
    bool setTorqueMode(uint8_t motor_id, float target_torque_nm)
    {
        ...
        switch (motor_id) {
            case 8:
            case 9:
                rated_torque_nm = 6.6f;
                break;
            case 10:
            case 11:
                rated_torque_nm = 4.4f;
                break;
            case 12:
            case 13:
                rated_torque_nm = 1.0f;
                break;
            default:
    ...
    * ========================================================= */
        ...
        const std::vector<double>& decel_rad_s2_list)// 目标减速度列表 (rad/s²)
    {
        ...
        for (size_t i = 0; i < count; ++i) {
            ...
            if (!receiveFrame(rx) || rx.data[0]!=0x02 || rx.data[1]!=0x0F || rx.data[2]!=0x01) {
